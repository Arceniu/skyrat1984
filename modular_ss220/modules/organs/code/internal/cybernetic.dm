//cybernetic stomach
/obj/item/organ/stomach/cybernetic/tool_act(mob/living/user, obj/item/tool, list/modifiers)
	. = ..()
...
/obj/item/organ/stomach/synth/tool_act(mob/living/user, obj/item/tool, list/modifiers)
	. = ..()
	if (tool.tool_behaviour == TOOL_SCREWDRIVER)
		if (cut_open_damage < 0)
			balloon_alert(user, "already cut open!")
