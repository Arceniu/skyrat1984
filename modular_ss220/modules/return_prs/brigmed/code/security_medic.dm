/datum/id_trim/job/security_medic
	...
	trim_icon = 'modular_ss220/modules/return_prs/brigmed/icons/card.dmi'
	...
	minimal_access = list(ACCESS_SECURITY, ACCESS_BRIG_ENTRANCE, ACCESS_BRIG, ACCESS_COURT, ACCESS_WEAPONS, ACCESS_MECH_SECURITY, ACCESS_MECH_MEDICAL, ACCESS_MINERAL_STOREROOM, ACCESS_MORGUE, ACCESS_MAINT_TUNNELS)
...
/obj/structure/closet/secure_closet/security_medic
	...
	icon = 'modular_ss220/modules/return_prs/brigmed/icons/closet.dmi'
	icon_state = "secmed"

/obj/structure/closet/secure_closet/security_medic/PopulateContents()
	..()
	new /obj/item/storage/bag/garment/brigmed(src)
	new /obj/item/storage/backpack/security/redsec(src)
