...
/obj/item/clothing/neck/greyscaled
	...
	icon = 'icons/map_icons/clothing/neck.dmi' // SS1984 NON-MODULAR EDIT (FIX FOR LATER OVERRIDE BY UPSTREAM), original: icon = 'modular_nova/master_files/icons/mob/clothing/neck.dmi'
