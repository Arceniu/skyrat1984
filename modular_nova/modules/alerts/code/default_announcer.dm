/datum/centcom_announcer/default
	...
	event_sounds = list(
		...
		ANNOUNCER_KLAXON = 'modular_ss220/modules/return_prs/black_mesa/sound/siren1_long.ogg', // SS1984 ADDITION
		ANNOUNCER_NRI_POLICE = 'modular_nova/modules/random_ship_event/random_ships/heliostatic_inspectors/sounds/morse.ogg', // SS1984 ADDITION
