/obj/machinery/vending/clothing
	product_categories_nova = list(
		...
		list(
			...
			"products" = list(
				...
				/obj/item/clothing/under/pants/nova/hakama = 5,
				/obj/item/clothing/under/pants/nova/double_skirt_dress = 5,
		...
		list(
			...
			"products" = list(
				...
				/obj/item/clothing/suit/toggle/jacket/nova/flannel = 5,
				/obj/item/clothing/suit/toggle/jacket/nova/flannel/red = 5,
				/obj/item/clothing/suit/toggle/jacket/nova/flannel/aqua = 5,
				/obj/item/clothing/suit/toggle/jacket/nova/flannel/brown = 5,
				/obj/item/clothing/suit/toggle/jacket/nova/hoodie = 5,
				/obj/item/clothing/suit/toggle/jacket/nova/hoodie/trim = 5,
				/obj/item/clothing/suit/toggle/jacket/nova/hoodie/trim/alt = 5,
				/obj/item/clothing/suit/toggle/jacket/nova/hoodie/branded = 5,
				/obj/item/clothing/suit/toggle/jacket/nova/hoodie/branded/cti = 5,
				/obj/item/clothing/suit/toggle/jacket/nova/hoodie/branded/mu = 5,
	...
	premium_nova = list( //being here means you're artificially rare, congratulations
		...
		/obj/item/clothing/gloves/designer = 2,
