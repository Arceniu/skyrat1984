...
//Dept Guards.
#define ALL_JOBS_DEPTGUARD JOB_CORRECTIONS_OFFICER, // SS1984 EDIT, original: #define ALL_JOBS_DEPTGUARD JOB_CORRECTIONS_OFFICER, JOB_ENGINEERING_GUARD, JOB_ORDERLY, JOB_SCIENCE_GUARD, JOB_CUSTOMS_AGENT, JOB_BOUNCER,
//Nanotrasen and Centcom
#define ALL_JOBS_CC JOB_NT_REP, JOB_BLUESHIELD
//Medical
#define ALL_JOBS_MED JOB_MEDICAL_DOCTOR, JOB_CHIEF_MEDICAL_OFFICER, JOB_CHEMIST, JOB_PARAMEDIC, JOB_CORONER, JOB_VIROLOGIST, JOB_PSYCHOLOGIST, // SS1984 EDIT, original: #define ALL_JOBS_MED JOB_MEDICAL_DOCTOR, JOB_CHIEF_MEDICAL_OFFICER, JOB_CHEMIST, JOB_PARAMEDIC, JOB_ORDERLY, JOB_CORONER, JOB_VIROLOGIST, JOB_PSYCHOLOGIST,
//Science
#define ALL_JOBS_SCI JOB_SCIENTIST, JOB_ROBOTICIST, JOB_GENETICIST, JOB_RESEARCH_DIRECTOR, JOB_CHEMIST, // SS1984 EDIT, original: #define ALL_JOBS_SCI JOB_SCIENTIST, JOB_ROBOTICIST, JOB_GENETICIST, JOB_RESEARCH_DIRECTOR, JOB_CHEMIST, JOB_SCIENCE_GUARD,
//Cargo
#define ALL_JOBS_CARGO JOB_QUARTERMASTER, JOB_CARGO_TECHNICIAN, JOB_SHAFT_MINER, JOB_BITRUNNER, // SS1984 EDIT, original: #define ALL_JOBS_CARGO JOB_QUARTERMASTER, JOB_CARGO_TECHNICIAN, JOB_CUSTOMS_AGENT, JOB_SHAFT_MINER, JOB_BITRUNNER,
//Engineering
#define ALL_JOBS_ENGI JOB_CHIEF_ENGINEER, JOB_STATION_ENGINEER, JOB_ATMOSPHERIC_TECHNICIAN, // SS1984 EDIT, original: #define ALL_JOBS_ENGI JOB_CHIEF_ENGINEER, JOB_STATION_ENGINEER, JOB_ATMOSPHERIC_TECHNICIAN, JOB_ENGINEERING_GUARD,
//Command
...
//Service
#define ALL_JOBS_SERV JOB_HEAD_OF_PERSONNEL, JOB_BARTENDER, JOB_CHEF, JOB_COOK, JOB_BOTANIST, JOB_CURATOR, JOB_CHAPLAIN, JOB_CLOWN, JOB_MIME, JOB_JANITOR , JOB_LAWYER, JOB_BARBER, JOB_PSYCHOLOGIST, // SS1984 EDIT, original: #define ALL_JOBS_SERV JOB_HEAD_OF_PERSONNEL, JOB_BARTENDER, JOB_CHEF, JOB_COOK, JOB_BOTANIST, JOB_CURATOR, JOB_CHAPLAIN, JOB_CLOWN, JOB_MIME, JOB_JANITOR , JOB_LAWYER, JOB_BARBER, JOB_BOUNCER, JOB_PSYCHOLOGIST,
