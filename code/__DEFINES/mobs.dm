...
#define BLOOD_VOLUME_SLIME_SPLIT BLOOD_VOLUME_MAXIMUM * 0.95 // Celadon EDIT, original: #define BLOOD_VOLUME_SLIME_SPLIT (BLOOD_VOLUME_MAXIMUM * 0.56) // 1120 units if BLOOD_VOLUME_MAXIMUM is 2000
