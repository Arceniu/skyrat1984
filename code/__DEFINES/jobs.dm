...
#define JOB_BRIDGE_ASSISTANT "Bridge Assistant" //#define JOB_BRIDGE_ASSISTANT "Bridge Officer" // NOVA EDIT CHANGE - ORIGINAL: #define JOB_BRIDGE_ASSISTANT "Bridge Assistant" //SS1984 Return from NOVA EDIT
