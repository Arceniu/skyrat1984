...
/datum/bodypart_overlay/mutant/tail/xeno
	color_source = NONE
	feature_key = FEATURE_TAIL_XENO // Celadon REVERT OF NOVA'S EDIT, original: feature_key = FEATURE_TAIL // NOVA EDIT CHANGE - CUSTOMIZATION - ORIGINAL: feature_key = FEATURE_TAIL_XENO
