/datum/job/security_officer
	...
	alternate_titles = list(
		...
		JOB_SECURITY_OFFICER_SERVICE, // Celadon ADDITION
	)
	job_flags = STATION_JOB_FLAGS | JOB_ANTAG_PROTECTED


GLOBAL_LIST_INIT(available_depts, list(SEC_DEPT_ENGINEERING, SEC_DEPT_MEDICAL, SEC_DEPT_SCIENCE, SEC_DEPT_SUPPLY, SEC_DEPT_SERVICE)) // Celadon EDIT, original: GLOBAL_LIST_INIT(available_depts, list(SEC_DEPT_ENGINEERING, SEC_DEPT_MEDICAL, SEC_DEPT_SCIENCE, SEC_DEPT_SUPPLY))
