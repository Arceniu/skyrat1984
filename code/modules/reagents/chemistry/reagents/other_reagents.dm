...
/datum/reagent/fuel/unholywater/on_mob_life(mob/living/carbon/affected_mob, seconds_per_tick, metabolization_ratio)
	...
	if(IS_CULTIST(affected_mob))
		...
		need_mob_update += affected_mob.adjust_stamina_loss(-0.5 * metabolization_ratio * seconds_per_tick, updating_stamina = FALSE)
		need_mob_update += affected_mob.adjust_tox_loss(-0.25 * metabolization_ratio * seconds_per_tick, updating_health = FALSE)
		need_mob_update += affected_mob.adjust_oxy_loss(-0.25 * metabolization_ratio * seconds_per_tick, updating_health = FALSE)
		...
		need_mob_update += affected_mob.adjust_brute_loss(-0.125 * REM * seconds_per_tick, updating_health = FALSE)
		need_mob_update += affected_mob.adjust_fire_loss(-0.125 * REM * seconds_per_tick, updating_health = FALSE)
		need_mob_update = TRUE
