...
/mob/living/basic/pet/dog/corgi/ian/Initialize(mapload)
	...
	if(age == 0)
		...
		icon_state = "corgi_old" // Celadon EDIT, original: icon_state = "old_corgi"
		icon_living = "corgi_old" // Celadon EDIT, original: icon_living = "old_corgi"
		held_state = "corgi_old" // Celadon EDIT, original: held_state = "old_corgi"
		icon_dead = "corgi_old_dead" // Celadon EDIT, original: icon_dead = "old_corgi_dead"
