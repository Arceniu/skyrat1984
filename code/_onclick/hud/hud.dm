...
/datum/hud
	...
	var/ui_style = null
	// CELADON REMOVAL var/erp_ui_style = null //NOVA EDIT - ADDITION - ERP ICONS FIX
...
/datum/hud/New(mob/owner)
	...
	if (!ui_style)
		...
		// CELADON REMOVAL erp_ui_style = erp_ui_style2icon(owner.client?.prefs?.read_preference(/datum/preference/choiced/ui_style)) //NOVA EDIT - ADDITION - ERP ICONS FIX
