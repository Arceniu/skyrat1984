...
//#define PRELOAD_RSC 0 // 0 to allow using external resources or on-demand behaviour; //Celadon EDIT CHANGE
#define PRELOAD_RSC 1 // Celadon SKYRAT EVENT ADDITION, ORIGINAL ABOVE
